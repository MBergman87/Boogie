...
public class BoogieApp {

    private static final Logger log = LoggerFactory.getLogger(BoogieApp.class);

    private final Environment env;

    public BoogieApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(BoogieApp.class);
